export const COMMAND_INDEX = [
  { label: 'Text Templates', to: '/templates/all-templates' },
  ...
  { label: 'Tenants', to: '/bulk/informational' },
  { label: 'Informational Bulk Flow', to: '/bulk/informational' },
  { label: 'Promotional Bulk Flow', to: '/bulk/promotional' },
